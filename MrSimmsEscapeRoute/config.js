var config = {
    style: 'mapbox://styles/acopod/cm0czjmcb015j01o0ee1sb1lx',
    ...
    chapters: [
            ...
            description1:'Arthur and his sister Mary Howland were frequent visitors at the Simms house.  One evening in 1884, Arthur asked William Simms to tell him the story of his journey from enslavement to freedom, twenty-six years after Mr. Simms came to New York State.  The detailed notes he made during that conversation formed the basis of the <a href="https://tompkins.nygenweb.net/tsimm.htm"> narrative that survives</a>, telling the story of the journey Simms made with seven other men from Chestnut Hill, Virginia to upstate New York and Canada.  That narrative is now the source of Tung Chen’s remarkable online interactive map and of Simms’s <a href="https://explore.cu.yourcultureconnect.com/e/ithaca-underground-railroad-trail/william-simmss-hard-won-life-in-tompkins-county">short history</a>, both of which are housed at the <a href="https://undergroundrailroadhub.net/about/">Underground Railroad Research Hub</a>.',
...
bearing: 0.00,
            ...
            description3:'2. Point of Rocks African Methodist Episcopal Church is a confirmed safe house/point on Underground Railroad. (The church was torn down several years ago)',
            description4:'3. St. Paul’s Episcopal Church is an unconfirmed Underground Railroad Site.',
            location: {
